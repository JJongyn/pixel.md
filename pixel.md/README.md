...
The package includes the [`pixel-md` skill](skills/pixel-md/SKILL.md), with component-specific references for indicators, chat effects, UI elements, bots, and terminal patterns. To add it to a project:
